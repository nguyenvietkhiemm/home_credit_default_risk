...
cols = ['AMT_CREDIT_MAX_OVERDUE', 'CNT_CREDIT_PROLONG',
       ...
       'AMT_ANNUITY',
       'AMT_CREDIT_SUM-s-AMT_CREDIT_SUM_DEBT',
       'AMT_CREDIT_SUM_DEBT-d-AMT_CREDIT_SUM',
       'AMT_CREDIT_MAX_OVERDUE-d-AMT_CREDIT_SUM',
       'AMT_CREDIT_SUM_OVERDUE-d-AMT_CREDIT_SUM',
       'AMT_CREDIT_SUM_DEBT-d-AMT_CREDIT_SUM_LIMIT',
       'AMT_CREDIT_SUM-s-AMT_CREDIT_SUM_DEBT-d-AMT_CREDIT_SUM_LIMIT',
       'AMT_CREDIT_SUM_DEBT-p-AMT_CREDIT_SUM_LIMIT',
       'AMT_CREDIT_SUM-d-AMT_CREDIT_SUM_DEBT-p-AMT_CREDIT_SUM_LIMIT',
       'AMT_ANNUITY-d-AMT_CREDIT_SUM', 'AMT_ANNUITY-d-AMT_CREDIT_MAX_OVERDUE',
       'AMT_ANNUITY-d-AMT_CREDIT_SUM_OVERDUE',
       'AMT_CREDIT_SUM-d-app_AMT_INCOME_TOTAL',
       ...
       'AMT_ANNUITY-d-app_AMT_INCOME_TOTAL', 'AMT_ANNUITY-d-app_AMT_CREDIT',
       'AMT_ANNUITY-d-app_AMT_ANNUITY', 'AMT_ANNUITY-d-app_AMT_GOODS_PRICE',]
