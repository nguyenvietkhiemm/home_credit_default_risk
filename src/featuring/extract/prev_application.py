...
def prev_extract(test_run=False):
    ...
    prev['AMT_CREDIT-d-total_debt'] = prev['AMT_CREDIT'] / prev['total_debt']  # so sánh số tiền phải trả thực tế so với số tiền vay đã được giải ngân
    ...
    cols = [
        ...
        'AMT_GOODS_PRICE-d-app_AMT_GOODS_PRICE', 'AMT_ANNUITY-s-app_AMT_GOODS_PRICE', 'AMT_APPLICATION-s-app_AMT_GOODS_PRICE', 'AMT_CREDIT-s-app_AMT_GOODS_PRICE',
        'AMT_GOODS_PRICE-s-app_AMT_GOODS_PRICE', 'AMT_ANNUITY-s-app_AMT_CREDIT-d-app_AMT_INCOME_TOTAL', 'AMT_APPLICATION-s-app_AMT_CREDIT-d-app_AMT_INCOME_TOTAL',
        'AMT_CREDIT-s-app_AMT_CREDIT-d-app_AMT_INCOME_TOTAL', 'AMT_GOODS_PRICE-s-app_AMT_CREDIT-d-app_AMT_INCOME_TOTAL', 'AMT_ANNUITY-s-app_AMT_ANNUITY-d-app_AMT_INCOME_TOTAL',
        'AMT_APPLICATION-s-app_AMT_ANNUITY-d-app_AMT_INCOME_TOTAL', 'AMT_CREDIT-s-app_AMT_ANNUITY-d-app_AMT_INCOME_TOTAL', 'AMT_GOODS_PRICE-s-app_AMT_ANNUITY-d-app_AMT_INCOME_TOTAL',
        'AMT_ANNUITY-m-app_AMT_GOODS_PRICE-d-app_AMT_INCOME_TOTAL', 'AMT_APPLICATION-m-app_AMT_GOODS_PRICE-d-app_AMT_INCOME_TOTAL', 'AMT_CREDIT-m-app_AMT_GOODS_PRICE-d-app_AMT_INCOME_TOTAL',
        'AMT_GOODS_PRICE-m-app_AMT_GOODS_PRICE-d-app_AMT_INCOME_TOTAL', 'interest_rate'
    ]
    
    diff_pctchange = multi.diff_pctchange(cols, prev)
    
    prev = pd.concat([prev, diff_pctchange], axis=1)
    ...
    def process_file(path, rem_max_unpaid, rem_max_paid):
