...
def pos_cash_extract(test_run=False):
    ...
    pos_balance = preprocessing(pos_balance)
    ...
    diff_pctchange = multi.diff_pctchange(cols, pos_balance)
    
    pos_balance = pd.concat([pos_balance, diff_pctchange], axis=1)
