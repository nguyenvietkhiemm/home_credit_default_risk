...
from config import ROOT, use_cols, prev_use_cols, bureau_money_cols, bureau_day_cols, app_money_cols, app_day_cols  # lib này được khởi tạo ban đầu dự án
...
def bureau_extract(test_run=False):
    ...
    bureau = pd.merge(bureau, utils.get_trte(), on='SK_ID_CURR', how='left')
    ...
    diff_pctchange = multi.diff_pctchange(cols, bureau)
